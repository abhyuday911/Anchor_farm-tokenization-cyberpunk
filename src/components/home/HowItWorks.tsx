...
import { Coins, TrendingUp, Repeat } from "lucide-react";

const steps = [
    {
        icon: Coins,
        title: "Tokenize Farm Assets",
        description: "Convert real-world agricultural assets into blockchain tokens, creating fractional ownership opportunities.",
    },
    {
        icon: TrendingUp,
        title: "Stake & Earn",
        description: "Stake your farm tokens to earn yield from agricultural production and seasonal harvests.",
    },
    {
        icon: Repeat,
        title: "Trade & Grow",
