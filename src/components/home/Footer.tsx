                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-6 gap-8 lg:gap-12 mb-8">
                    <div className="sm:col-span-2 lg:col-span-2">
                        ...
                        <p className="text-muted-foreground mb-6 max-w-sm">
                            Revolutionizing agriculture investment through blockchain technology.
                            Tokenize, trade, and grow your agricultural portfolio.
                        </p>
                ...
                <div className="pt-4 border-t border-border">
                    <div className="flex flex-col md:flex-row justify-between items-center gap-6">
                        <p className="text-sm text-muted-foreground text-center md:text-left">
                            © 2025 FarmToken. All rights reserved. Built with blockchain technology for sustainable agriculture.
                        </p>
